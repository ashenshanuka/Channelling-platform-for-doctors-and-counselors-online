                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="../assets/images/Coun_logo.png" alt="homepage" class="dark-logo" style="width: 245px; height: 70px;" />
                                  <!-- <img src="../assets/images/ad_logo.png" alt="homepage" class="dark-logo" style="width: 270px; height: 68px;" /> -->
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
