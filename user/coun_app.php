...
if (isset($_GET['d_id'])) {
  $d_id = $_GET['d_id'];
  $counselorQuery = $obj->query("SELECT f_name, l_name FROM doc_pro WHERE d_id = '$d_id'");
  if ($counselorQuery->num_rows > 0) {
    $counselorData = $counselorQuery->fetch_object();
    $counselorName = $counselorData->f_name . ' ' . $counselorData->l_name;
  }
}
 ...
 <section class="w3l-contact-2 py-5" id="contact">
  <div class="container py-lg-4 py-md-3 py-2">
    <div class="title-content text-center">
      ...
      <h3 class="title-w3l mb-lg-4">Book an appoinment with <?php echo $counselorName; ?> !!<br>
         </h3>
          ...
          <div class="input-grids">
            ...
            <input type="email" name="email" id="email" placeholder="Your Email*" class="contact-input"
             ...
             <input type="text" name="num" id="num" placeholder="Your Contact*" class="contact-input"
              ...
              <label class="contact-input">Selected Counselor</label>
            <input type="text" value="<?php echo $counselorName; ?>" class="contact-input" readonly>
            <br>
          </div>
